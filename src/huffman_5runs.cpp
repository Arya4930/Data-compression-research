...
const std::string HUFFMAN_EXE = "huffman.exe";
...
bool runHuffman(
    ...
    /*
        Your existing huffman.exe asks the user
...
int main()
{
    try {
        ...
        std::cout
            << "\n"
            << "============================================================\n"
            << "HUFFMAN 5-RUN THREAD SCALING EXPERIMENT\n"
            << "============================================================\n\n";
        ...
        if (
            ...
            std::cerr
                << "Make sure huffman.exe is inside:\n"
                << fs::current_path()
                << "\n";
        ...
        std::cout
            << "IMPORTANT:\n"
            << "This program will execute huffman.exe "
            << totalRuns
            << " times.\n\n"

            << "Each execution processes all 15 datasets.\n\n"

            << "Previous timestamped results will NOT be deleted.\n\n";
        ...
        std::cout
            << "\nResults are stored by huffman.exe "
