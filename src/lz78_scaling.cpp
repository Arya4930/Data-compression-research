    ...
    try {
        ...
        /*
            ...
            Therefore:
                ...
                ../results/lz78_all_runs.csv

            points to:

                research-paper/results/lz78_all_runs.csv
        */
        ...
        if (
            ...
            fs::path alternative =
                current
                /
                "../results/lz78/lz78_all_runs.csv";
        ...
        std::cout
            << "\n"
            << "============================================================\n"
            << "lz78 THREAD SCALING ANALYZER\n"
            << "============================================================\n\n";

        std::cout
            << "Using existing lz78 benchmark results only.\n";
        ...
        if (
            ...
            std::cerr
                << "ERROR: Cannot find lz78 master CSV.\n\n"
...
graph(
    ...
    "lz78 Compression Time vs Threads",
...
graph(
    ...
    "lz78 Decompression Time vs Threads",
...
graph(
    ...
    "lz78 Compression Throughput vs Threads",
...
graph(
    ...
    "lz78 Decompression Throughput vs Threads",
...
graph(
    ...
    "lz78 Compression Speedup vs Threads",
    "Speedup (x)",
...
graph(
    ...
    "lz78 Decompression Speedup vs Threads",
    "Speedup (x)",
...
graph(
    ...
    "lz78 Parallel Efficiency vs Threads",
    "Parallel Efficiency (%)",
...
graph(
    ...
    "lz78 Decompression Efficiency vs Threads",
    "Parallel Efficiency (%)",
...
graph(
    ...
    "lz78 Compression Ratio vs Threads",
    "Compression Ratio",
...
graph(
    ...
    "lz78 Compression Timing Variation vs Threads",
...
print()
print("All lz78 graphs generated.")
)PY";
